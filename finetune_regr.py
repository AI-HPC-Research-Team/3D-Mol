...
def train(args, model, label_mean, label_std, train_dataset, collate_fn, criterion, encoder_opt=None, head_opt=None):
    """
    ...
    list_loss = []
    model.train()
    for atom_bond_graphs, bond_angle_graphs, dihes_angle_graphs, labels in data_gen:
...
def main(args):
    ...
    for epoch_id in range(args.max_epoch):
        s = time.time()
        train_loss = train(args, model, label_mean, label_std, train_dataset, collate_fn, criterion, encoder_opt,
                           head_opt)
